...
2. Put your Gemini API key in a `.env` file in the root dir ```GEMINI_API_KEY=[your secret key]```. If you don't have already, go create one on [Google AI Studio](https://aistudio.google.com/).
